        ...
        <div class="header-top">
            <div class="top-left1">
                ...
                <ul class="list-style-one">
                    <li><i class="fa fa-map-marker-alt"></i> 106, Floor-1, Plot-140, Plaza Shopping Centre, Sheriff Devji Street Mumbai 400003</li>
                    <li><i class="fa fa-clock"></i> Mon - Sat: 10am - 06pm</li> 
                    <li><i class="fa fa-phone-volume"></i> <a href="#">+91 9819980001 /+022 23479362 </a></li>
                </ul>
            </div>
                ...
                <div class="nav-outer">
                    ...
                    <nav class="nav main-menu">
                        <ul class="navigation">
                            ...
                            <li><a href="page-get-quote.html">Get Quote</a></li>

                            <li><a href="page-clients.html">Client</a></li>

                            <li class="dropdown"><a href="#">Investor</a>
                                <ul>
                                    <li class="dropdown"><a href="#">Our Management</a>
                                        <ul>
            ...
            <div class="auto-container">
                <div class="inner-container">
                    <div class="copyright-text">
                        <p>&copy; Copyright 2023 by  <a href="index-2.html">Sahara Maritime Pvt Ltd. All rights Reserved.</a></p>
                    </div>
